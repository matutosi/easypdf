...
2.  combine_pdf.xlsx のinputs列とoutputs列にファイル名を入力．
    -   inputs: 入力ファイル名
    -   outputs: 出力ファイル名
    -   outputs列のファイル名が同じものを上から順に結合． <img src="setting.png" width="80%"/>
...
2.  Enter the file names in the inputs and outputs columns of combine_pdf.xlsx.
    ...
    -   The files with the same Input files will be combined according the name in the outputs column from the top. <img src="before.png" width="80%"/>
